...
///////////////////////////////////////////////////////////////////////////////////////
  ...
  var save = function() {
    ...
    if ( field.dataset.autosave === "true" ) {
      ...
      console.warn("changed detected on field:", field.name, "| type:", field.type, "| location:", field.dataset.saveLocation, "| group:", field.dataset.group);
      ...
      else if ( field.type === 'text' || field.type === 'number' || field.type === 'select-one' ) {
