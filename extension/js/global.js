...
/////
/////
/////   Chrome Storage Functions - Simplified
/////
/////   "location" is either "sync" or "local"
/////
/////   "data" is an object
/////
///////////////////////////////////////
...
function _set(location, data) {

  chrome.storage[location].set(data);

}

function _get(location, data) {

  chrome.storage[location].get(data);
