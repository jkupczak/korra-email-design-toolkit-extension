...
function courseOptions() {
  ...
  function saveOptions() {
    ...
    if ( tracking !== "" ) {
      tracking = "?utm_content=mod" + tracking + "-courses"
    }
...
function generateCode(codeType, audience, whiteLabel, tracking) {
  ...
  for (let exportCourse of selectedCourses) {
    ...
    var courseLink = exportCourse.dataset.href.replace(/www/gi, whiteLabel) + tracking;
